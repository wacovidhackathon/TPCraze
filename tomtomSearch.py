...
def geo(address):
	...
	query = 'https://api.tomtom.com/search/2/geocode/' + \
		str(encoded) + '.json?limit=1&countrySet=US&lat=42&lon=-72&topLeft=42.886%2C%20-73.508&btmRight=41.237%2C-69.928&key=' + apiKey
